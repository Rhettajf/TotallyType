...
function checkcontrast() {
	...
	var mybg = document.getElementById("pair");
	var mybg2 = document.getElementById("preview");
	...
	if (L1!==false && L2!==false) {
		...
		mybg2.style.backgroundColor = "#"+bgcolor;
		mybg.style.color = "#"+color;
		mybg2.style.color = "#"+color;
		...
		normal.style.color = "#444444";
		normal.style.backgroundColor = "#F7F7F7";
		big.style.color = "#444444";
		big.style.backgroundColor = "#F7F7F7";
